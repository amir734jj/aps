...
void dump_scala_Program(Program p,std::ostream&oss)
{
  ...
  string id = module_name == "" ? program_id(aps_yyfilename) : module_name;
...
void dump_some_class_decl(Declaration decl, ostream& oss)
{
  ...
  string trait_name = module_name == "" ? symbol_name(def_name(some_class_decl_def(decl))) : module_name;
...
void dump_scala_Declaration(Declaration decl,ostream& oss)
{
  ...
  case KEYmodule_decl:
	...
	case KEYno_type:	  
      ...
      TO_UPPER_IN_PLACE(module_name);
      string class_name = module_name == "" ? symbol_name(def_name(some_class_decl_def(decl))) : module_name;
